    ...
    return MaterialApp(
      ...
      Scaffold(
        ...
        body:
            ...
            StreamBuilder(
              stream: Firestore.instance.collection('nub').snapshots(),
...
//MEtodo que llama a la funcion
 void colocar(String sms) async{
   await bd.collection("nub").add({'nu':sms});
 }
          ...
          Column(
            children: <Widget>[
              Container(
                ...
                child:
                Text(nubecita.data['nu'],style: TextStyle(fontSize: 20, color: Colors.black),),
              )
            ],
          ),
        ),
